...
export function Logo(style) {
    ...
    return (
        <motion.div initial={{ opacity: 0, x: -100 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.5 }} className="relative flex-no-wrap flex w-full items-center justify-between z-50">
