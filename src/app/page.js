...
export default function Home() {
    ...
    return (
        <main className="relative flex flex-col items-center justify-between h-screen scroll-smooth focus:scroll-auto">
            ...
            <Parallax id="pv" modStyle="h-1/2 text-orange-400 font-bold" src="./img/Photovoltaik/pv.jpg">
            ...
            <Parallax id="elektro" modStyle="h-1/2 text-orange-400 font-bold" src="./img/Elektro/elektro.jpg">
            ...
            <Parallax id="netz" modStyle="h-1/2 text-orange-400 font-bold" src="./img/Netzwerk/netz.jpg" >
