...
export default function Home() {
    ...
    return (
        <main className="relative flex-col items-center justify-between h-screen scroll-smooth focus:scroll-auto scroll-p-60">
            ...
            <Parallax modStyle="h-1/2 brightness-50" src="./img/Photovoltaik/pv.jpg">
                <h1>Photovoltaik</h1>
            </Parallax>
            <ContentContainer id="pv" />

            <Parallax modStyle="h-1/2 brightness-50" src="./img/Elektro/elektro.jpg" />
            <ContentContainer id="elektro" />

            <Parallax modStyle="h-1/2 brightness-50" src="./img/Netzwerk/netz.jpg" />
